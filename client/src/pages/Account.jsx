...
<div className="w-full max-w-lg bg-white shadow-xl rounded-2xl p-6 sm:p-8 space-y-6">
        ...
        {isEditingPassword &&
          <div className="fixed inset-0 z-40 flex items-center justify-center backdrop-blur-sm px-8">
            <div className="flex flex-col space-y-4 px-8 py-8 bg-white min-w-100 h-auto items-center rounded-lg justify-center">
              ...
              {passwordCheck === "Password Correct" ?
                <>
                  ...
                  <input
                    className="px-2 py-1  outline-none border border-blue-500 rounded  w-full focus:ring-2 focus:ring-blue-400 transition duration-300
